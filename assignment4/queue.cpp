...
/*********************************************************************
** Function: void Queue::addBack(characterType* charType)
** Description: Adds a number to the back of the queue to line it up.
** Parameters: characterType* charType
...
void Queue::addBack(CharacterType* character)
{
	if(isEmpty())
	{
...
/*********************************************************************
** Function: Queue()
** Description: The default constructor for the queue()
** Parameters: N/A
** Pre-Conditions: Program starts up and user runs the program in main.cpp.
** Post-Conditions: N/A
*********************************************************************/ 

CharacterType* Queue::getFront()
{
	if(!head)
	{
