...
/*********************************************************************  
** Function: bool TheShadow::shadowMovement()
** Description: The shadow has a special move, that allows it to dodge all attacks.
** Parameters: int _characterAttack
** Pre-Conditions: The program calls for the Shadow to itself and them makes a coin toss.
** Post-Conditions: The shadow deftly dodges the blow/deflects it.
*********************************************************************/

bool TheShadow::shadowMovement()
{
...
** Description: The shadow's defense throw.
** Parameters: int _characterAttack
